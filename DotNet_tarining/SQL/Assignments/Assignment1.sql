...
insert into Clients 
Values(1001,'ACME Utilities','Pune','contact@acmeutil.com','9567880032','Manufacturing'),
...
values(2001,'Rajesh','Analyst',25000,10),
        (2002,'sandy','Designer',30000,10),
		(2003,'Vamsi','Developer',40000,20),
		(2004,'Kiran','Developer',40000,20),
		(2005,'Bhanu','Designer',35000,10),
		(2006,'Arjun','Tester',30000,30),
		(2007,'Gita','TechWriter',30000,40),
		(2008,'suma','Tester',35000,30),
		(2009,'Likhitha','developer',45000,20),
		(2010,'smitha','Analyst',20000,10),
		(2011,'Anand','projectMgr',65000,10)
